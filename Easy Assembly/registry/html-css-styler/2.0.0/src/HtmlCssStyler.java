    ...
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(in)); FileWriter fw = new FileWriter(out)) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                } else if (line.startsWith("<div>") && line.endsWith("</div>")) {
                    String inner = line.substring(5, line.length()-6);
                    fw.write("DISPLAY \"DIV: " + inner + "\"\n");
                } else if (line.startsWith("<span>") && line.endsWith("</span>")) {
                    String inner = line.substring(6, line.length()-7);
                    fw.write("DISPLAY \"SPAN: " + inner + "\"\n");
                }
            }
            fw.write("HALT\n");
        }
        System.out.println("Wrote styled_output.ea (v2.0.0)");
    }
}
